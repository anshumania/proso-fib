  ...
  main(void) 
{
  ...
  /* Initializes keyboard management */
  init_keyboard();

  /* Initializes devices and file system management */
  init_filesystem();

  /* Initializes task 0 data */
  init_task0();

  /* Move user code/data now (after the page table initialization) */
  copy_data((void *) KERNEL_START + *p_sys_size, usr_main, *p_usr_size);

  /* Now the system is ready to handle interrupts*/
  iniTics(); /* inits tics counter */
  enable_int();
